...
- Do NOT commit or push the spec — it is a local working artifact; leave it unstaged for the user to review. Gitignore the spec directory if it is tracked.
...
> "Spec written to `<path>` (local, not committed). Please review it and let me know if you want to make any changes before we start writing out the implementation plan."
